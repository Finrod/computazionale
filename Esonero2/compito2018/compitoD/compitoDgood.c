...
void controlla_e_init(int argc, char**argv, 
  ...
  *nbins=atoi(argv[3]); 
  ...
  esp1->h     = alloca_double(*nbins);
  esp2->h     = alloca_double(*nbins);
...
double box_muller(){
  ...
  r1=lrand48()/(double)NORMA;
  r2=lrand48()/(double)NORMA;
